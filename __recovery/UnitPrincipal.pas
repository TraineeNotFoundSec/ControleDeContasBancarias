...
begin
  ...
  queryBancosForm.SQL.Text := 'SELECT id, nome, cpf, fixo, celular, cep, endereco, numero, bairro, id_uf, id_municipio FROM clientes WHERE id = :id;';
  queryBancosForm.ParamByName('id').AsInteger := queryClientes.FieldByName('ID').AsInteger;
  queryClientesForm.Open;
